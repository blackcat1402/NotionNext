...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '69399eaf941e41628c432bbd1ae97bcc',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || ' This cat is an esteemed coding influencer on TradingView, commanding an audience of over 8,000 followers. This cat is proficient in developing quantitative trading algorithms across a diverse range of programming languages, a skill that has garnered widespread acclaim. Consistently, this cat shares invaluable trading strategies and coding insights. Regardless of whether you are a novice or a veteran in the field, you can derive an abundance of valuable information and inspiration from this blog.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.tradingview.com/u/blackcat1402/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'TradingView, blackcat1402, Pine Script, Python, Technical Analysis, Strategies, Trading Bots, Indicators, Crypto Trading, Stocks Trading, Trading Principles, Trading Notes, TA Tutorial, Customized Services, Interesting Tools', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'blackcat14023uk@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://t.me/+Zo5uohStMm5iMTU1', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/_blackcat1402', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://medium.com/@blackcat1402.tradingview', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/+NbtZW0BpPC01NDVl', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://discord.com/invite/ZTGpQJq', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@blackcat1402.tradingview', // Youtube主页
  ...
  FACEBOOK_PAGE_ID: process.env.NEXT_PUBLIC_FACEBOOK_PAGE_ID || '177278518800777', // Facebook Page ID 來啟用 messenger 聊天功能
  FACEBOOK_APP_ID: process.env.NEXT_PUBLIC_FACEBOOK_APP_ID || '1040523393834050', // Facebook App ID 來啟用 messenger 聊天功能 获取: https://developers.facebook.com/
  ...
  BACKGROUND_LIGHT: '#ffffcc', // use hex value, don't forget '#' e.g #fffefc, default: #eeeeee
  BACKGROUND_DARK: '#6666cc', // use hex value, don't forget '#', default: #000000
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'blackcat1402/blog-comments', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOKxubZw', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOKxubZ84CbOy5', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'blackcat1402 blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
