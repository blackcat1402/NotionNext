...
const BLOG = {
  ...
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://www.tradingview.com/u/blackcat1402/', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/_blackcat1402', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/tangly1024', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'blackcat1402's blog', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
